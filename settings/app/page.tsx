    ...
    <main className="flex min-h-screen flex-col items-center bg-slate-800">
      <div className="w-[1440px] flex flex-col">
        ...
        <div className="px-[70px] flex justify-between">
          <div className="w-[330px] flex flex-col items-center gap-4 bg-white p-8 h-fit">
            <div className="flex flex-col gap-1 p-4">
              <p className="font-semibold text-sm px-4 py-1 rounded-lg border border-gray-400">
                Basic Information
              </p>
            ...
            <div className="p-2 w-full">
              <button className="w-full rounded-2xl p-2 flex justify-center bg-slate-800 text-white items-center gap-2">
                <p className="font-bold text-xs">Save Changes</p>
              </button>
            </div>
          </div>

          <div className="w-[954px] flex flex-col gap-4 bg-white p-9 ">
            <div className="flex justify-between p-4 border border-gray-300 rounded">
              ...
              <div className="h-full p-[1px] bg-gray-500"></div>
              ...
              <div className="p-2 grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    type="text"
                    className="py-2 px-3 rounded-lg border border-gray-500"
                    placeholder="name"
                  />
                </div>
            ...
            <div className="flex flex-col gap-4 p-4 border border-gray-300 rounded">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="rounded-2xl py-3  px-5 flex justify-center bg-slate-800 text-white items-center gap-2">
                  <MapIcon />
                  <p className="font-bold text-xs">Add</p>
                </button>
              </div>
            </div>
            <div className="flex flex-col gap-4 p-4 border border-gray-300 rounded">
