    ...
    <main className="flex min-h-screen flex-col items-center bg-slate-800">
      <div className="w-[1440px] flex flex-col">
        ...
        <div className="px-[70px] flex justify-between">
          <div className="w-[330px] flex flex-col items-center gap-4 bg-white p-4">
            <Image
              src={"/images/maloi.png"}
              width={171}
              height={172}
              alt=""
              className="rounded-full"
            ></Image>
            <p className="font-semibold">Recolts</p>
            <p>UI/UX Designer and Web Developer</p>
            <div className="flex items-center">
              <MapIcon />
              <p className="font-medium text-xs">Philippines</p>
            </div>
            <div className="flex items-center justify-center p-4 w-full ">
              <button className="w-full rounded-2xl p-2 flex justify-center bg-slate-800 text-white items-center gap-2">
                <EditIcon />
                <p className="font-bold text-xs">Edit Your Profile</p>
              </button>
            </div>
            <div className="flex flex-col gap-2 p-4 w-full font-medium text-xs">
            ...
            <div className="flex flex-col gap-1 p-4 w-full ">
              ...
              <div className="rounded-lg p-2 flex items-center justify-between border border-gray-500">
                <div className="flex items-center gap-1">
                  <LinkedInIcon />
                  <p className="font-bold text-xs">LinkedIn</p>
                </div>
                <ExternalLinkIcon />
              </div>
              ...
              <div className="rounded-lg p-2 flex items-center justify-between border border-gray-500">
                ...
                <ExternalLinkIcon className="text-red-700" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2 p-4 w-full ">
              ...
              <p className="font-medium text-xs">
                Freelance UI/UX Designer and Web Developer
              </p>
            </div>
            <div className="flex items-center justify-center p-4 w-full">
              <button className="w-full rounded-2xl p-2 flex justify-center bg-slate-800 text-white items-center gap-2">
          ...
          <div className="w-[954px] flex flex-col items-center gap-4 bg-white p-9">
            <div className="flex items-center gap-4 w-full p-2">
              <p className="bg-slate-500 py-2 px-4 rounded-3xl text-white">
                Work
              </p>
              <p>Your Stats</p>
              <p>Drafts</p>
